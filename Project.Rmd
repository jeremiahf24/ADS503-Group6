...
summary(df_eda)  ### put into a gt() Table???? #################################
...
colSums(is.na(trainData))  #### Look for the N/A Values from other r doc####
...
ctrl <- trainControl(method = "repeatedcv", 
                     number = 10,  # folds for repetition
                     repeats = 1,  ### change from 1 to 5
