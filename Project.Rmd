...
grid <- expand.grid(size = c(1, 5, 10),     # Number of hidden units
...
print(paste('Best Size and Decay tuning parameters for Random Forest:', paste(rfFit_stroke, collapse = ',')))
```
